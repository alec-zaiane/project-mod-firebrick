...
urlpatterns = [
    ...
    path('hosted_images/', views.api_hosted_images, name='hosted_images_api'),
    path('hosted_images/<int:image_id>/', views.api_delete_hosted_image, name='delete_hosted_image_api'),
]