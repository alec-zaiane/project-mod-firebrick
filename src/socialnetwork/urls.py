...
urlpatterns = [
    ...
    path("author/<uuid:target_author_uuid>",
         views.author_profile_view, name="author_profile"),
    path("author/<uuid:target_author_uuid>/modify",
         views.local_author_modify_view, name="author_modify"),
    ...
    path("api/post/delete/<uuid:post_uuid>",
         views.api_post_delete, name="api_post_delete"),
    path("api/create_text_post", views.api_create_text_post,
         name="api_create_text_post"),
    path("api/author/update/<uuid:target_author_uuid>",
         views.api_author_update, name="api_author_update"),
]
