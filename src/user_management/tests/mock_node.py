...
class MockNodeManager(models.Manager["MockNode"]):
    ...
    def create_node(self, host_url: str, internal_user: User, name: str = "mock_node") -> MockNode:
        return self.create(host_url=host_url, internal_user=internal_user, name=name)
